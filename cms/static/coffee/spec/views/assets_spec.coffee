define ["jasmine", "sinon", "squire", "js/models/asset", "js/collections/asset", "js/views/asset", "js/views/assets"],
(jasmine, sinon, Squire, AssetModel, AssetCollection, AssetView, AssetsView) ->
    ...
    describe "Asset model", ->
        beforeEach ->
            ...
            @model = new AssetModel({display_name: "test asset", url: 'actual_asset_url', portable_url: 'portable_url', date_added: 'date', thumbnail: null, id: 'id'})
            ...
            @injector = new Squire()
            @injector.mock("js/views/feedback_prompt", Squire.Helpers.constructs({
                "Warning": @promptSpies
            }))
        ...
        describe "Basic", ->
            it "should render properly", ->
                @injector.require ["js/views/asset"], (AssetView) =>
        ...
        describe "AJAX", ->
            beforeEach ->
                ...
                @injector = new Squire()
                @injector.mock("js/views/feedback_notification", Squire.Helpers.constructs({
                    "Confirmation": @confirmationSpies,
                    "Mini": @savingSpies
                }))
    ...
    describe "Assets view", ->
        beforeEach ->
            ...
            @collection.url = "update-asset-url"
            @view = new AssetsView({collection: @collection, el: $('#asset_table_body')})
        ...
        describe "Basic", ->
            ...
            it "adds an asset if asset does not already exist", ->
                @injector.require ["js/views/asset"], (AssetView) =>
                    ...
                    @view.render()
                    model = new AssetView({display_name: "new asset", url: 'new_actual_asset_url', portable_url: 'portable_url', date_added: 'date', thumbnail: null, id: 'idx'})
                    @view.addAsset(model)
